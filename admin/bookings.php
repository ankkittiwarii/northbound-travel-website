...
<title>Manage Bookings | NorthBound</title>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
<style>
    /* Inherit layout from dashboard */
...
<div class="sidebar">
    ...
    <a href="bookings.php" class="active"><i class="fa-solid fa-suitcase-rolling"></i> Manage Bookings</a>
...
<div class="main-content">
    ...
    <?php if(isset($_GET['deleted'])){ ?>
        <div class="alert alert-success"><i class="fa-solid fa-check-circle"></i> Booking deleted successfully.</div>
    <?php } ?>
        ...
        <table>
            ...
            <?php if(mysqli_num_rows($result) > 0){ ?>
                ...
                <tr>
                    ...
                    <td>
                        <a class="delete-btn" href="delete_booking.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Delete this booking? This cannot be undone.');">
            ...
            <?php } else { ?>
                <tr>
                    <td colspan="8" class="no-data"><i class="fa-solid fa-folder-open"></i> No bookings found.</td>
                </tr>
            <?php } ?>
        </table>
    </div>
